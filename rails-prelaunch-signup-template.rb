...
@prefs = {:railsapps=>"rails-prelaunch-signup", :dev_webserver=>"webrick", :prod_webserver=>"same", :templates=>"haml", :ban_spiders=>true, :jsruntime=>false, :rvmrc=>false, :github=>true, :quiet_assets=>true}
@gems = []
